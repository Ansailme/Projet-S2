...
{
    Couleur noir{0,0,0};
    Couleur deg{(m_adjacents.size())*50, 255-m_adjacents.size()*50,100-m_adjacents.size()*50};

    svgout.addDisk(m_x*100,m_y*100,10,deg);
    svgout.addText(m_x*100-10,m_y*100-10,m_lettre,noir);
}
