...
/// header svgfile.h tiré de correction TP 6 maillage de M FERCOQ repris integralement
...
{
    public:
        Svgfile(std::string _filename = "output.svg", int _width=1900, int _height=1100);
        ~Svgfile();
        ...
        void addTrait (int mod, int tri, std::string color=defcol);
